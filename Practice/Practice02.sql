...
예) 2005년 08월 20일(토요일)
*/
select case when date_format(min(hire_date),'%Y년 %m월 %d일%W') = date_format(min(hire_date),'%Y년 %m월 %d일Monday') then date_format(min(hire_date),'%Y년 %m월 %d일(월요일)')
			when date_format(min(hire_date),'%Y년 %m월 %d일%W') = date_format(min(hire_date),'%Y년 %m월 %d일Tuesday') then date_format(min(hire_date),'%Y년 %m월 %d일(화요일)')
            when date_format(min(hire_date),'%Y년 %m월 %d일%W') = date_format(min(hire_date),'%Y년 %m월 %d일Wednesday') then date_format(min(hire_date),'%Y년 %m월 %d일(수요일)')
            when date_format(min(hire_date),'%Y년 %m월 %d일%W') = date_format(min(hire_date),'%Y년 %m월 %d일Thursday') then date_format(min(hire_date),'%Y년 %m월 %d일(목요일)')
            when date_format(min(hire_date),'%Y년 %m월 %d일%W') = date_format(min(hire_date),'%Y년 %m월 %d일Friday') then date_format(min(hire_date),'%Y년 %m월 %d일(금요일)')
            when date_format(min(hire_date),'%Y년 %m월 %d일%W') = date_format(min(hire_date),'%Y년 %m월 %d일Saturday') then date_format(min(hire_date),'%Y년 %m월 %d일(토요일)')
			when date_format(min(hire_date),'%Y년 %m월 %d일%W') = date_format(min(hire_date),'%Y년 %m월 %d일Sunday') then date_format(min(hire_date),'%Y년 %m월 %d일(일요일)')
        end '가장 오랜 근속한 직원의 입사일'
from employees
;